<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="40" heigth="40">
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      ></path>
      <path d="M10 16H6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
      <circle cx="18" cy="17" r="3" stroke="currentColor" stroke-width="1.5"></circle>
      <path
